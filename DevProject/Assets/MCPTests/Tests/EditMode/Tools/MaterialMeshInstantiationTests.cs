...
namespace MCPForUnityTests.Editor.Tools
{
    ...
    public class MaterialMeshInstantiationTests
    {
        ...
        public void GetComponentData_UsesSharedMaterialInsteadOfMaterial()
        {
            ...
            int beforeId = meshRenderer.sharedMaterial != null ? meshRenderer.sharedMaterial.GetEntityId() : 0;
            var result = GameObjectSerializer.GetComponentData(meshRenderer);
            int afterId = meshRenderer.sharedMaterial != null ? meshRenderer.sharedMaterial.GetEntityId() : 0;
        ...
        public void GetComponentData_UsesSharedMeshInsteadOfMesh()
        {
            ...
            int beforeId = meshFilter.sharedMesh != null ? meshFilter.sharedMesh.GetEntityId() : 0;
            var result = GameObjectSerializer.GetComponentData(meshFilter);
            int afterId = meshFilter.sharedMesh != null ? meshFilter.sharedMesh.GetEntityId() : 0;
