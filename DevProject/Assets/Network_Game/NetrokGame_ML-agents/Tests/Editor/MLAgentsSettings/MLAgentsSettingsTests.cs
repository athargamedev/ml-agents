...
namespace MLAgentsExamples.Tests.Settings
{
    ...
    public class MLAgentsSettingsTests
    {
        ...
        {
            var assetsGuids = AssetDatabase.FindAssets(
                "t:MLAgentsSettings",
                new string[] { tempSettingsRootPath }
            );
        ...
        internal class MockSettingsProvider
        {
            public MLAgentsSettingsProvider Instance
            {
                get
                {
                    return (MLAgentsSettingsProvider)
                        typeof(MLAgentsSettingsProvider)
            ...
            {
                var method = typeof(MLAgentsSettingsProvider).GetMethod(
                    "Reinitialize",
