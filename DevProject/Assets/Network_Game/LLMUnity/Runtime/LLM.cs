...
namespace LLMUnity
{
    ...
    public class LLM : MonoBehaviour
    {
        ...
        [DynamicRange("minContextLength", "maxContextLength", false), Model, SerializeField]
        ...
        void OnValidate()
        {
            ...
            if (maxContextLength <= 0 && !string.IsNullOrEmpty(_model))
            {
                ModelEntry entry = LLMManager.Get(_model);
                if (entry != null && entry.contextLength > 0)
                {
            ...
            await Task.Run(() =>
            {
                lock (staticLock)
                {
                    ...
                    if (
                        ...
                        serverString = processorType.Contains("Intel")
        ...
        public static async Task<bool> WaitUntilModelSetup(
        ...
        public void SetModel(string path)
        {
            ...
            ModelEntry modelEntry =
                LLMManager.Get(model) ?? new ModelEntry(GetLLMManagerAssetRuntime(model));
