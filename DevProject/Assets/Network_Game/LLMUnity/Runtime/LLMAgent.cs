    ...
    public class LLMAgent : LLMClient
    {
        ...
        public string systemPrompt
        {
            ...
            set
            {
                if (_systemPrompt != value)
                {
                    _systemPrompt = value;
                    if (llmAgent != null)
                        llmAgent.SystemPrompt = _systemPrompt;
                }
            }
        }
        ...
        protected override void OnValidate()
        {
            ...
            if (
                ...
                && (slot < -1 || slot >= llm.parallelPrompts)
            )
            {
        ...
        public virtual async Task<string> Chat(
            string query,
        ...
        )
        {
            ...
            try
            {
                ...
                if (callback != null)
                {
                    ...
                    Action<string> mainThreadCallback = Utils.WrapActionForMainThread(
                        callback,
                        this
                    );
                ...
                result = await llmAgent.ChatAsync(
                    query,
                    addToHistory,
                    wrappedCallback,
                    false,
                ...
                if (this == null)
                    return null;
                if (addToHistory && result != null && save != "")
                    _ = SaveHistory();
                if (this != null)
